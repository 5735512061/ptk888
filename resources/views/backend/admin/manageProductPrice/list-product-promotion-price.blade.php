        ...
        <div class="page-body">
            <div class="card table-card">
                ...
                <div class="card-block">
                    <form action="{{url('/admin/search-list-product-promotion-price')}}" enctype="multipart/form-data" method="post">@csrf
                            ...
                            <tbody>
                                @foreach ($products as $product => $value)
                                    <tr>
                                        ...
                                        @endif
                                        <td>       
                                            <a href="{{url('/admin/edit-product-promotion-price')}}/{{$value->id}}">
                                                <i class="fa fa-pencil-square-o" style="color:blue;"></i>
                                            </a> 
                                            <a href="{{url('/admin/product-promotion-price-detail')}}/{{$value->id}}">
