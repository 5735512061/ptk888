                                ...
                                @foreach ($messages as $message => $value)
                                    <tr>
                                        @php
                                            ...
                                            $name = DB::table('stores')->where('id',$value->store_id)->value('name');
                                            $phone = DB::table('stores')->where('id',$value->store_id)->value('phone');
                                        @endphp
                                    ...
                                    <div class="modal fade" id="ModalStatus{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{url('/admin/answer-message-store')}}" enctype="multipart/form-data" method="post">@csrf
