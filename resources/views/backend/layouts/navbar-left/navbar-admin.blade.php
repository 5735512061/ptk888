        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class=" ">
                        <a href="{{url('/admin/claim-product')}}" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class=" ">
                        <a href="{{url('/admin/list-product-promotion-price')}}" class="waves-effect waves-dark">
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">จัดการราคาโปรโมชั่น</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="{{url('/admin/list-product-price-store')}}" class="waves-effect waves-dark">
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">ราคาสินค้าแบบแผ่น</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="{{url('/admin/list-product-price-store-film-brand')}}" class="waves-effect waves-dark">
