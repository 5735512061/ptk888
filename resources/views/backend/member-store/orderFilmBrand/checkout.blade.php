...
@else 
<form action="{{url('/store/payment-checkout-store/film-brand')}}" enctype="multipart/form-data" method="post">@csrf
<div class="row">
    <div class="col-md-8">
        <div class="main-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="cart-summary" style="text-align: center;">
                                            ...
                                            <div class="cart-btn">
                                                <a style="text-decoration: none;" href="{{url('/store/payment-checkout-store/film-brand')}}">
