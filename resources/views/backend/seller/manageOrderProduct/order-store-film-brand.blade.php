        ...
        <div class="page-body">
            <div class="card table-card">
                ...
                <div class="card-block">
                    <form action="{{url('/seller/search-order-store-film-brand')}}" enctype="multipart/form-data" method="post">@csrf
                            ...
                            <tbody>
                                @foreach ($orders as $order => $value)
                                    <tr>
                                        ...
                                        <td>
                                            @if($status == null || $status == 'รอยืนยัน')
                                                <a href="{{url('/seller/delete-order-store-film-brand/')}}/{{$value->id}}" style="color: red;" onclick="return confirm('ต้องการยกเลิกคำสั่งซื้อ ?')">
                                                    ยกเลิกการสั่งซื้อ
                                                </a>
                                            @elseif($status == 'กำลังจัดส่ง')
