        ...
        <div class="page-body">
            <div class="card table-card">
                ...
                <div class="card-block">
                    <form action="{{url('/seller/search-list-product-price')}}" enctype="multipart/form-data" method="post">@csrf
                            ...
                            <tbody>
                                @foreach ($products as $product => $value)
                                    <tr>
                                        ...
                                        @endif
                                        <td>       
                                            <a href="{{url('/seller/edit-product-price')}}/{{$value->id}}">
                                                <i class="fa fa-pencil-square-o" style="color:blue;"></i>
                                            </a> 
                                            <a href="{{url('/seller/product-price-detail')}}/{{$value->id}}">
