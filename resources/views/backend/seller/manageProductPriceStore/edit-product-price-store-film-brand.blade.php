                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form action="{{url('/seller/update-product-price-store-film-brand')}}" enctype="multipart/form-data" method="post">@csrf
                                ...
                                @endforeach
                                @php
                                    $film_type = DB::table('film_types')->where('id',$product_store_film_brand->film_type_id)->value('film_type');
                                @endphp
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">ชื่อสินค้า</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{$product_store_film_brand->film_brand}} {{$film_type}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-4 offset-md-2">
                                        <input type="hidden" name="product_id" value="{{$product_store_film_brand->id}}">
