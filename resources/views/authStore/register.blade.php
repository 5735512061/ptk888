...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('ลงทะเบียนสมาชิกร้านค้า') }}</div>
                ...
                <div class="card-body">
                    <form action="{{url('/admin/register-store')}}" enctype="multipart/form-data" method="post">@csrf
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('รหัสสมาชิกร้านค้า') }}</label>
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('ชื่อร้านค้า') }}</label>
