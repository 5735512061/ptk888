...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('ลงทะเบียนแอดมิน') }}</div>
                ...
                <div class="card-body">
                    <form action="{{url('/register')}}" enctype="multipart/form-data" method="post">@csrf
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('รหัสแอดมิน') }}</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('admin_id') ? ' is-invalid' : '' }}" name="admin_id" value="{{ old('admin_id') }}" required autofocus>
